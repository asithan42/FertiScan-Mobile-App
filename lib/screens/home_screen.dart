...
import 'package:get/get.dart'; // ✅ Add this if not already imported
...
//                         fit: BoxFit.cover,
//                       ),
//                     ).animate().scale(duration: 600.ms, begin: const Offset(0.8, 0.8)).fadeIn()
//                   ),
